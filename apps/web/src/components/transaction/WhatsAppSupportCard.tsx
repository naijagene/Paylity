  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-2xl border-2 border-success/20 bg-success/5 px-4 py-3.5 text-sm font-semibold text-success transition-colors hover:border-success/30 hover:bg-success/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-success focus-visible:ring-offset-2"
        aria-label="Chat with PAYLITY Support on WhatsApp"
      >
        <WhatsAppIcon />
        Chat with PAYLITY Support
      </a>
    </aside>
  );
}
