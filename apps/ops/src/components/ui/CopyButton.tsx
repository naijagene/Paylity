...
export function CopyButton({
  ...
  return (
    <button
      ...
      className={`inline-flex min-h-11 items-center justify-center rounded-xl border border-border-green bg-success-light px-4 py-2.5 text-sm font-semibold text-dark transition-all hover:bg-success/15 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-success focus-visible:ring-offset-2 motion-reduce:active:scale-100 ${className}`}
